...
public class Main {
    ...
    /**
     * Metoda główna aplikacji, która inicjalizuje interfejs użytkownika Lanterna.
    ...
    public static void main(String[] args) {
        try {
            ...
            RGBConverterWindow rgbConverterWindow = new RGBConverterWindow(gui, mainwindow, todoListWindow);
